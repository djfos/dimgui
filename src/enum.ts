...
export enum ImGuiWindowFlagBits
{
    None                      = 0,
...
export enum ImGuiInputTextFlagBits
{
    None                = 0,
...
export enum ImGuiTreeNodeFlagBits
{
    None                 = 0,
...
//   IMPORTANT: because the default parameter is 1 (==ImGuiPopupFlagBitsMouseButtonRight), if you rely on the default parameter
//   and want to use another flag, you need to pass in the ImGuiPopupFlagBitsMouseButtonRight flag explicitly.
// - Multiple buttons currently cannot be combined/or-ed in those functions (we could allow it later).
export enum ImGuiPopupFlagBits
{
    None                    = 0,
...
export enum ImGuiSelectableFlagBits
{
    None               = 0,
...
export enum ImGuiComboFlagBits
{
    None                    = 0,
...
export enum ImGuiTabBarFlagBits
{
    None                           = 0,
...
export enum ImGuiTabItemFlagBits
{
    None                          = 0,
...
//    - Default to ImGuiTableFlagBitsSizingFixedFit    if ScrollX is on, or if host window has ImGuiWindowFlagBitsAlwaysAutoResize.
//    - Default to ImGuiTableFlagBitsSizingStretchSame if ScrollX is off.
// - When ScrollX is off:
//    - Table defaults to ImGuiTableFlagBitsSizingStretchSame -> all Columns defaults to ImGuiTableColumnFlagBitsWidthStretch with same weight.
...
// - When ScrollX is on:
//    - Table defaults to ImGuiTableFlagBitsSizingFixedFit -> all Columns defaults to ImGuiTableColumnFlagBitsWidthFixed
...
export enum ImGuiTableFlagBits
{
    // Features
    None                       = 0,
    ...
    // Decorations
    RowBg                      = 1 << 6,   // Set each RowBg color with ImGuiCol_TableRowBg or ImGuiCol_TableRowBgAlt (equivalent of calling TableSetBgColor with ImGuiTableBgFlagBitsRowBg0 on each row manually)
...
export enum ImGuiTableColumnFlagBits
{
    ...
    NoSort                = 1 << 9,   // Disable ability to sort on this field (even if ImGuiTableFlagBitsSortable is set on the table).
...
export enum ImGuiTableRowFlagBits
{
    None                     = 0,
...
// When using ImGuiTableFlagBitsRowBg on the table, each row has the RowBg0 color automatically set for odd/even rows.
// If you set the color of RowBg0 target, your color will override the existing RowBg0 color.
// If you set the color of RowBg1 or ColumnBg1 target, your color will blend over the RowBg0 color.
export enum ImGuiTableBgTarget
{
    None                     = 0,
    RowBg0                   = 1,        // Set row background color 0 (generally used for background, automatically set when ImGuiTableFlagBitsRowBg is used)
...
export enum ImGuiFocusedFlagBits
{
    None                          = 0,
...
// Note: windows with the ImGuiWindowFlagBitsNoInputs flag are ignored by IsWindowHovered() calls.
export enum ImGuiHoveredFlagBits
{
...
export enum ImGuiDockNodeFlagBits
{
    None                         = 0,
...
export enum ImGuiDragDropFlagBits
{
    None                         = 0,
...
{
    IS8,       // signed char / char (with sensible compilers)
    IU8,       // unsigned char
    IS16,      // short
    IU16,      // unsigned short
    IS32,      // int
    IU32,      // unsigned int
    IS64,      // long long / __int64
    IU64,      // unsigned long long / unsigned __int64
    IFloat,    // float
    IDouble,   // double
    ICOUNT
}
...
export enum ImGuiConfigFlagBits
{
    ...
    NavEnableGamepad       = 1 << 1,   // Master gamepad navigation enable flag. Backend also needs to set ImGuiBackendFlagBitsHasGamepad.
    ...
    ViewportsEnable        = 1 << 10,  // Viewport enable flags (require both ImGuiBackendFlagBitsPlatformHasViewports + ImGuiBackendFlagBitsRendererHasViewports set by the respective backends)
...
export enum ImGuiBackendFlagBits
{
    None                  = 0,
    ...
    HasSetMousePos        = 1 << 2,   // Backend Platform supports io.WantSetMousePos requests to reposition the OS mouse position (only used if ImGuiConfigFlagBitsNavEnableSetMousePos is set).
...
export enum ImGuiButtonFlagBits
{
    None                   = 0,
...
export enum ImGuiColorEditFlagBits
{
    None            = 0,
...
export enum ImGuiSliderFlagBits
{
    None                   = 0,
    ...
    Logarithmic            = 1 << 5,       // Make the widget logarithmic (linear otherwise). Consider using ImGuiSliderFlagBitsNoRoundToFormat with this if using a format-string with small amount of digits.
