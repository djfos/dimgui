...
export function tableGetColumnName_Int(column_n: number): StringSource {
...
export function setTabItemClosed(
  tab_or_docked_window_label: StringSource,
): void {
