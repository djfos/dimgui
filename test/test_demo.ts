...
import { CBool, ImGuiCol, ImGuiDir, ImVec2 } from "../mod.ts";
...
export function showDemoWindowWidgets() {
  ...
  if (imgui.treeNode("Basic")) {
    ...
    imgui.radioButton("radio a", e == 0, () => e = 0);
    imgui.sameLine();
    imgui.radioButton("radio b", e == 1, () => e = 1);
    imgui.sameLine();
    imgui.radioButton("radio c", e == 2, () => e = 2);
